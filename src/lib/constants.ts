...
export const INDUSTRY_SUBSECTORS: Record<string, string[]> = {
  ...
  "Manufacturing Advanced": ["Building of ships and boats", "Manufacture of air and spacecraft machinery", "Manufacture of batteries and accumulators", "Manufacture of communication equipment", "Manufacture of computers and peripheral equipment", "Manufacture of consumer electronics", "Manufacture of electric motors, generators and transformers", "Manufacture of electric motors, generators, transformers and electricity distribution and control ap", "Manufacture of electronic components and boards", "Manufacture of general-purpose machinery", "Manufacture of motor vehicles", "Manufacture of other electrical equipment", "Manufacture of railway locomotives and rolling stock", "Manufacture of special-purpose machinery", "Treatment and coating of metals; machining"],
